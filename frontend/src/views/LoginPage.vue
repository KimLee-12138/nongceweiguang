  ...
  <div class="editorial-auth-page">
    <div class="auth-brand-panel">
      ...
      <div class="brand-copy">
        <h1 class="brand-title fade-up delay-1">欢迎回来。<br />你的政策工作台已就绪。</h1>
      ...
      <div class="form-wrapper">
        ...
        <el-form ref="formRef" :model="form" :rules="rules" label-width="0" class="editorial-form fade-up delay-2" @submit.prevent="handleSubmit">
          <el-form-item prop="username">
            <el-input v-model="form.username" placeholder="请输入用户名" size="large" clearable class="apple-input" />
          </el-form-item>
        ...
        <div class="form-footer fade-up delay-3">
          <button type="button" class="text-link" @click="go('/register')">创建新账户</button>
...
import { getAuthErrorMessage, loginUserSession } from '../services/authSession'
...
async function handleSubmit() {
  ...
  loading.value = true
  try {
    const result = await loginUserSession({ username: form.username.trim(), password: form.password })
